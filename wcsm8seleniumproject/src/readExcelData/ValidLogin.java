...
public class ValidLogin {
	public static void main(String[] args) throws EncryptedDocumentException, IOException, InterruptedException {
		...
		//Read the valid username from ActTimeTestData excel sheet
		
		FileInputStream fis = new FileInputStream("./data/ActiTimeTestData.xlsx");	//provide the path of excel sheet
		...
		String validUserName = cell.getStringCellValue();	//read the value from cell
		
	

	//Read the Valid password from ActTimeTestData excel
